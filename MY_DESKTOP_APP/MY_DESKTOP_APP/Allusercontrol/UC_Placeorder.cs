...
namespace MY_DESKTOP_APP.Allusercontrol
{
    public partial class UC_Placeorder : UserControl
    {
        ...
        private void ComboType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            query = "SELECT name FROM details WHERE type = '" + category + "'";
            ShowItemList(query);
        }
        ...
        {
            String category = ComboType.Text;
            query = "SELECT name FROM details WHERE type = '" + category + "' AND name LIKE '" + txtSearch.Text + "%'";
            ShowItemList(query);
        }
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            query = "SELECT price FROM details WHERE name = '" + text + "'";
            DataSet ds = fn1.getData(query);
